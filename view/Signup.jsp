...
<style type="text/css">
    ...
    .myform {
        ...
        background: linear-gradient(180deg, rgba(210, 193, 179, 0.48783263305322133) 0%, rgba(245, 133, 27, 1) 4%, rgba(226, 212, 202, 1) 47%,
...
<body>
    ...
    <div class="container-fluid py-5 main">
        <div class="container signup text-light justify-content-center">
            <form:form action="insert" method="post" id="reg"
				commandName="reg">
                ...
                <div class="form-group ">
                    ...
                    <form:input type="text" class="form-control" path="mobile" id="mobile" placeholder="Mobile"/>
                ...
                <div class="form-group ">
                    ...
                    <form:input type="password" class="form-control" path="cnf_password" id="cnf_password"
                ...
                <div class="form-group">
                    <label class="text-right">Existing User? <a href="/PassportWeb/log/login">click here</a></label>
                </div>
    ...
    <script>
        ...
        bootstrapValidate('#password', 'regex::Password should be strong')
